...
class TextureCooker:
    ...
    def cookPS3(input_texture, output_texture):
        _Texture = Texture(input_texture, output_texture, "PS3")
        _Texture.getTextureData()
        _Texture.cookGtf()
        _Texture.serializeHeader()
        _Texture.writeCookedTexture()
    ...
    def cookX360(input_texture, output_texture):
        _Texture = Texture(input_texture, output_texture, "X360")
        _Texture.getTextureData()
        _Texture.cookXpr()
        _Texture.serializeHeader()
        _Texture.writeCookedTexture()
    ...
    def Cook(input_texture, output_texture, platformType, IMAGETODDS=False):
        ...
        if platformType == "PS3":
            TextureCooker.cookPS3(input_texture, output_texture)
